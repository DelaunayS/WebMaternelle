...
$('#carte1').css('font-size', '13vw') // adapte la police pour les 2 mains 
...
function nombreEnSymboleDoigt(choix) {
    switch (choix) {
        ...
        case 16:
            return choix_reel = 'UQ';
        case 17:
            return choix_reel = 'UR';
        case 18:
            return choix_reel = 'US';
        case 19:
            return choix_reel = 'UT';
        case 20:
            return choix_reel = 'UU';
