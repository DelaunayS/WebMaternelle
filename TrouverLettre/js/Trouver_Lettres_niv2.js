...
$('.carte').css('font-size', '6vw') //adapte la taille des minuscules à la carte
...
var lettreATrouver = function() {
    ...
    $('#quelleLettre').text(bonRésultat.toLocaleUpperCase())
    return bonRésultat
}
...
$('#interrogation').on('click', function() {
    $('#quelleLettre').text((bonRésultat.toLocaleUpperCase()) + '    ' + bonRésultat)
});
