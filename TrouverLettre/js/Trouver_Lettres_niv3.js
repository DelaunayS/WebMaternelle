...
$('.carte').css('font-size', '5vw') //adapte la taille des minuscules à la carte
$('.carte').css('font-family', 'cursive_standardregular') // transforme les lettres en cursive
...
var lettreATrouver = function() {
    ...
    $('#lettre').text(bonRésultat.toLocaleUpperCase())
    return bonRésultat
}
...
$('#interrogation').on('click', function() {
    $("#lettreAide").css('font-family', 'cursive_standardregular')
    $("#lettreAide").css('margin-left', '3vw')
    $("#lettreAide").text(bonRésultat)
